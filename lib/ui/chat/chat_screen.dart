...
//                 ? const Icon(Icons.person, color: kTextDark)
//                 : null,
//           ),
...
//                 children: [
//                   _roundIconButton(
//                     icon: _showEmojiPicker ? Icons.close : Icons.emoji_emotions,
//                     onTap: () =>
...
//                         hintText:
//                             isEditing ? 'Editing message...' : 'Type a message...',
//                         filled: true,
...
//                   ),
//                 ),
//                 // If your emoji_picker_flutter version requires the newer API, replace the above
//                 // EmojiPicker with this block instead:
//                 // child: EmojiPicker(
//                 //   onEmojiSelected: (_, emoji) =>
//                 //       setState(() => _controller.text += emoji.emoji),
//                 //   config: const Config(
