...
//   /// 🔹 User Card Widget
//   Widget _buildUserCard(Map<String, dynamic> user, {bool isRequest = false}) {
//     // Correctly handle nested 'users' map
...
//       ),
//       child: ListTile(
//         onTap: () => !isRequest ? _openChat(nested) : null,
//         contentPadding: const EdgeInsets.all(12),
//         leading: CircleAvatar(
//           radius: 28,
//           backgroundColor: kGreen.withOpacity(0.1),
...
//           ),
//         ),
//         // Removed popup menu as requested
//       ),
//       body: _loading
//           ? const Center(child: CircularProgressIndicator())
//           : RefreshIndicator(
...
//                     ),
//                     ..._requests.map((req) {
//                       return _buildUserCard(req, isRequest: true);
//                     }),
//                     const Divider(),
//                   ],
//                   if (_users.isNotEmpty)
...
class _ChatListScreenState extends State<ChatListScreen> {
  ...
  /// 🔹 Accept a friend request (optimistic update)
  Future<void> _acceptRequest(Map<String, dynamic> req) async {
    final requestId = req['id']?.toString() ?? '';
    final fromUserId = req['user_id']?.toString() ?? '';
                  ...
                  if (_requests.isNotEmpty) ...[
                    ...
                    ..._requests.map((req) {
                      return Dismissible(
                        ...
                        child: _buildUserCard(req, isRequest: true),
                      );
                    }),
                    const Divider(),
                  ],
