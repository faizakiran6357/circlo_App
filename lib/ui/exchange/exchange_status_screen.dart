...
//                   ),
//                   const SizedBox(height: 8),
//                   // ✅ Requested item tap opens item detail screen
               
// GestureDetector(
//   onTap: () {
//     if (itemDetails != null) {
//       final itemModel = Item.fromMap(itemDetails!); // convert map → Item model
//       Navigator.push(
//         context,
//         MaterialPageRoute(
...
//                          onTap: () {
//   final itemModel = Item.fromMap(item); // convert Map to Item model
//   Navigator.push(
//     context,
//     MaterialPageRoute(
//       builder: (_) => ItemDetailScreen(item: itemModel),
